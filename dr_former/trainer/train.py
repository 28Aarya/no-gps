...
<<<<<<< HEAD
    ...
    p.add_argument("--activation", choices=["gelu", "relu", "silu", "elu"], default="gelu")
    p.add_argument("--batch_size", type=int, default=64)
    p.add_argument("--epochs", type=int, default=10)
    p.add_argument("--lr", type=float, default=0.0001)
    p.add_argument("--weight_decay", type=float, default=0.01)
    p.add_argument("--clip_grad", type=float, default=1.0)
    p.add_argument("--loss", choices=["mse", "huber", "tukey", "weighted_mse", "weighted_huber", "weighted_tukey"], default="weighted_huber")
=======
...
<<<<<<< HEAD
    p.add_argument("--scheduler", choices=["none", "step", "cosine", "plateau"], default="cosine")
=======
...
<<<<<<< HEAD
    p.add_argument("--arch", choices=["dr_res","dual_stream"], default="dr_res", help="Model architecture to use")
=======
